...
# HTTP 302 → 图片直接输出</code></pre>
  ...
  "data": {
    "total_images": 1234,
    "total_categories": 15,
    "version": "<?= defined('APP_VERSION') ? APP_VERSION : '1.1.1-beta.5' ?>",
  ...
  "data": {
    ...
    "storage_driver": "local"
        ...
        <footer class="footer">
            ...
            <p class="mt-1">MoeRNG v<?= defined('APP_VERSION') ? APP_VERSION : '1.1.1-beta.5' ?> &mdash; Open-source under MIT License</p>
